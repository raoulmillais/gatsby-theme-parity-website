...
export default function SubstratePage({ data }: SubstratePageProps) {
  ...
  return (
    <Layout theme="light">
      ...
      <section className="bg-parityBlack -mt-4">
        ...
        <div className="container flex  flex-col px-4 pt-12 pb-24">
          <div className="mt-12 md:flex md:justify-center">
            ...
            <div className="md:w-1/2 md:mx-4 md:flex md:flex-col md:justify-center">
              <h3 className="text-2xl md:text-3xl">{intl.formatMessage({ id: 'substrate-page-intro-one-title' })}</h3>
              <p className="text-lg">{intl.formatMessage({ id: 'substrate-page-intro-one-description' })}</p>
          ...
          <div className="mt-12 md:flex md:justify-center md:flex-row-reverse">
            ...
            <div className="md:w-1/2 md:mx-4 md:flex md:flex-col md:justify-center">
              <h3 className="text-2xl md:text-3xl">{intl.formatMessage({ id: 'substrate-page-intro-two-title' })}</h3>
              <p className="text-lg">{intl.formatMessage({ id: 'substrate-page-intro-two-description' })}</p>
              <hr className="border-1 border-parityPink w-12" />
              <ul>
                <li className="text-base md:text-xl font-light">
          ...
          <div className="mt-12 md:flex md:justify-center">
            ...
            <div className="md:w-1/2 md:mx-4 md:flex md:flex-col md:justify-center">
              <h3 className="text-2xl md:text-3xl">{intl.formatMessage({ id: 'substrate-page-intro-three-title' })}</h3>
              <p className="text-lg">{intl.formatMessage({ id: 'substrate-page-intro-three-description' })}</p>
              <hr className="border-1 border-parityPink w-12" />
              <ul>
                <li className="text-base md:text-xl font-light">
        ...
        <div className="container py-16 md:py-32  md:max-w-5xl">
          <div className="md:flex">
            <div className="md:w-1/2">
              <p className="mx-4 md:text-2xl">{intl.formatMessage({ id: 'substrate-page-table-one-title' })}</p>
            </div>
            <div className="w-full md:w-1/2">
              ...
              <div className="flex items-center bg-white mx-4 text-sm">
                ...
                <div className="w-1/2 pl-4 py-3">{intl.formatMessage({ id: 'substrate-page-table-one-rust' })}</div>
              </div>
            </div>
          </div>
          <div className="pt-12 md:flex">
            <div className="md:w-1/2">
              ...
              <p className="mx-4 text-sm text-textLight md:text-base">
            ...
            <div className="w-full md:w-1/2">
              <div className="flex items-center bg-white mx-4 text-sm border-b">
                ...
                <div className="w-1/2 pl-4 py-3">{intl.formatMessage({ id: 'substrate-page-table-two-libp2p' })}</div>
              </div>
              <div className="flex items-center bg-white mx-4 text-sm border-b">
                <div className="w-1/2 pl-4 py-3">
                  {intl.formatMessage({ id: 'substrate-page-table-two-algorithm' })}
                </div>
                <div className="w-1/2 pl-4 py-3">{intl.formatMessage({ id: 'substrate-page-table-two-hybrid' })}</div>
              </div>
              <div className="flex items-center bg-white mx-4 text-sm border-b">
                <div className="w-1/2 pl-4 py-3">{intl.formatMessage({ id: 'substrate-page-table-two-beacon' })}</div>
                <div className="w-1/2 pl-4 py-3">
              ...
              <div className="flex items-center bg-white mx-4 text-sm border-b">
                ...
                <div className="w-1/2 pl-4 py-3">{intl.formatMessage({ id: 'substrate-page-table-two-ed25519' })}</div>
              </div>
              <div className="flex items-center bg-white mx-4 text-sm border-b">
                <div className="w-1/2 pl-4 py-3">{intl.formatMessage({ id: 'substrate-page-table-two-hashing' })}</div>
                <div className="w-1/2 pl-4 py-3">{intl.formatMessage({ id: 'substrate-page-table-two-blake2b' })}</div>
              </div>
              <div className="flex items-center bg-white mx-4 text-sm">
                <div className="w-1/2 pl-4 py-3">{intl.formatMessage({ id: 'substrate-page-table-two-address' })}</div>
                <div className="w-1/2 pl-4 py-3">{intl.formatMessage({ id: 'substrate-page-table-two-base-58' })}</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-wrap justify-center">
            {data.substrateTeams.edges.map((edge: any) => (
              <div key={edge.node.id} className="flex flex-col justify-center mx-6 my-4">
                ...
                <Img
                  className="h-auto w-20 my-3 opacity-60"
      ...
      <section className="bg-textDark">
        <div className="flex flex-col md:flex-row md:justify-center md:items-center py-12">
          ...
          <div className="text-gray-300 mx-4 -mt-6 lg:w-1/2 max-w-lg">
            <h4 className="md:text-3xl">{intl.formatMessage({ id: 'substrate-page-launch-blockchain-title' })}</h4>
            <p className="md:text-lg">{intl.formatMessage({ id: 'substrate-page-launch-blockchain-description' })}</p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="container py-16 max-w-2xl">
            <div className="text-center text-white">
              ...
              <p className="text-sm mt-0">{intl.formatMessage({ id: 'substrate-page-gave-quote-title' })}</p>
            </div>
          </div>
        </div>
      </section>
