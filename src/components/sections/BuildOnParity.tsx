    ...
    <section>
        <div className="md:flex ">
            <div className="h-64 md:h-96 md:w-1/2">
                <img className="h-full w-full object-cover" src={image} alt="World Food Programme build on Parity Technologie" />
            </div>
            <div className="text-textDark px-6 pb-12 md:w-1/2 lg:flex lg:justify-center">
                <div className="lg:w-2/3">
                    ...
                    <span className="text-xs text-parityPink font-bold">
                        <LocalizedLink className="no-underline" to="/un-world-food-programme-uses-parity-ethereum-to-aid-100-000-refugees/">
