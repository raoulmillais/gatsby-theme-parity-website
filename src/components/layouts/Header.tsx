    ...
    <header className="container md:flex md:justify-between md:px-4 md:py-4">
      <div className="flex items-center justify-between px-4 py-3 md:p-0">
        ...
        <div className="md:hidden">
          <button
            type="button"
            className="block bg-white border-0 focus:outline-none"
            onClick={() => setIsOpen(!isOpen)}
          >
            <svg className="h-6 w-6 bg-white" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
      ...
      >
        ...
        <div className="flex justify-center items-center px-2 py-1 my-4 md:my-0">
          <a href="https://twitter.com/substrate_io" target="_blank" rel="noreferrer">
