...
blogTitle: 'Security Alert: Ethereum Constantinople Postponement'
slug: blog/security-alert-ethereum-constantinople-postponement
date_published: 2019-01-15T06:00:00+01:00
image: "/images/parity-ethereum-security-alert.png"

---
_Parity Technologies supports the consensus reached to postpone the Constantinople upgrade. Stay updated on the latest Constantinople and Parity Ethereum developments at_ [_@ParityTech_](https://twitter.com/ParityTech) _or this blog post,_ [_originally published on Ethereum.org_](https://blog.ethereum.org/2019/01/15/security-alert-ethereum-constantinople-postponement/)_._
...
## How the decision to postpone the Constantinople fork was made
