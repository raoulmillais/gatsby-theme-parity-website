...
<!--YOUTUBE SNIPPER--> <iframe className="w-full h-56 sm:h-80 md:h-96" src="https://www.youtube.com/embed/fCHsbs96lvE" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
