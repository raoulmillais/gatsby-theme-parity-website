...
* Implemented the [Recovery pallet](https://www.parity.io/social-recovery-on-substrate/), with some features implemented in their web-based wallet interface
...
[**Unique Network**](https://usetech.com/unique/) is a Substrate-based blockchain serving non-fungible tokens (NFTs).
...
* Delivery of **Ask!**, a smart contract language designed based on AssemblyScript and running on[ Substrate FRAME Contracts](https://substrate.dev/docs/en/knowledgebase/smart-contracts/overview#contracts-module)
...
* First draft of [PatraStore](https://patrastore.io/jupiter-a1), a Polkadot.js-based DApp interface for applications built on Patract
