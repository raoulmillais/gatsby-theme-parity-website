...
blogTitle: Hello, Substrate!
slug: blog/hello-substrate/
date_published: 2019-11-22T01:00:00+01:00
image: "/images/hello-substrate.png"

---
# **An Introduction to the Substrate Blockchain Framework**
...
![Hello Substrate](/images/hello-substrate-image-one.png "Hello Substrate")
...
To learn more about these basics of a blockchain, visit the demo/videos found here: [https://anders.com/blockchain/](https://anders.com/blockchain/ "https://anders.com/blockchain/")
...
![Hello Substrate](/images/hello-substrate-image-two.png "Hello Substrate")
...
![Hello Substrate](/images/hello-substrate-image-three.png "Hello Substrate")
...
![Hello Substrate](/images/hello-substrate-image-six.png "Hello Substrate")

## **Substrate Runtime**

So far, we have touched on all the core blockchain components that Substrate provides to you. As you have read, Substrate has made every effort to stay as generic and extensible as possible. However, arguably the most customizable part of Substrate is its **modular** runtime. The runtime is Substrate’s _state transition function_ mentioned earlier.
...
![Hello Substrate](/images/hello-substrate-image-eight.png "Hello Substrate")
...
In the spirit of Substrate’s flexibility, you do not need to enable this feature at all. If you want to disable on-chain upgrades, you can. Truly, Substrate provides you with all the tools needed for your chain.
...
Substrate is a project born from [Polkadot](https://polkadot.network/), a larger vision of a world with many interoperable blockchains. Substrate powers the blockchain that will connect this public network in addition to most of the chains that will connect to this network. When Polkadot is launched, you can feel secure that the technology that backs your blockchain is the same technology that powers multiple other production-level blockchains.
